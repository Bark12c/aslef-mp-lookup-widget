...
window.aslefMpList = {
 "Ipswich": {
  ...
  "North Norfolk": {
    "name": "Steff Aquarone",
    "party": "Liberal Democrat",
    "email": "steff.aquarone.mp@parliament.uk"
  },
  "Melton and Syston": {
    "name": "Edward Argar",
    "party": "Conservative",
  ...
  "Lowestoft": {
    "name": "Jess Asato",
    "party": "Labour",
    "email": "jess.asato.mp@parliament.uk"
  },
  ...
  "Cardiff West": {
    ...
    "party": "Labour",
    "email": "alex.barroscurtis.mp@parliament.uk"
  },
  ...
  "Brighton Pavilion": {
    "name": "Si\u00e2n Berry",
    "party": "Green Party",
    "email": "sian.berry.mp@parliament.uk"
  },
  ...
  "Redditch": {
    "name": "Chris Bloore",
    "party": "Labour",
    "email": "chris.bloore.mp@parliament.uk"
  },
  ...
  "Chichester": {
    ...
    "party": "Liberal Democrat",
    "email": "jess.brownfuller.mp@parliament.uk"
  },
  "Rhondda and Ogmore": {
    "name": "Chris Bryant",
    "party": "Labour",
  ...
  "Southend West and Leigh": {
    ...
    "party": "Labour",
    "email": "david.burtonsampson.mp@parliament.uk"
  },
  "Brent East": {
    "name": "Dawn Butler",
    "party": "Labour",
  ...
  "Penrith and Solway": {
    ...
    "party": "Labour",
    "email": "markus.campbellsavours.mp@parliament.uk"
  },
  ...
  "Birmingham Selly Oak": {
    "name": "Al Carns",
    "party": "Labour",
    "email": "al.carns.mp@parliament.uk"
  },
  "South Suffolk": {
  ...
  "Poole": {
    ...
    "party": "Labour",
    "email": "neil.duncanjordan.mp@parliament.uk"
  },
  ...
  "Guildford": {
    "name": "Z\u00f6e Franklin",
    "party": "Liberal Democrat",
    "email": "zoe.franklin.mp@parliament.uk"
  },
  "Mid Norfolk": {
    "name": "George Freeman",
    "party": "Conservative",
  ...
  "Newry and Armagh": {
    "name": "D\u00e1ire Hughes",
    "party": "Sinn F\u00e9in",
    "email": "daire.hughes.mp@parliament.uk"
  },
  ...
  "Aylesbury": {
    ...
    "party": "Labour",
    "email": "laura.kyrkesmith.mp@parliament.uk"
  },
  "Ceredigion Preseli": {
    "name": "Ben Lake",
    "party": "Plaid Cymru",
  ...
  "Huntingdon": {
    ...
    "party": "Conservative",
    "email": "ben.obesejecty.mp@parliament.uk"
  },
  ...
  "High Peak": {
    "name": "Jon Pearce",
    "party": "Labour",
    "email": "jon.pearce.mp@parliament.uk"
  },
  ...
  "Hendon": {
    ...
    "party": "Labour",
    "email": "david.pintoduschinsky.mp@parliament.uk"
  },
  ...
  "Solihull West and Shirley": {
    ...
    "party": "Conservative",
    "email": "neil.shastrihurst.mp@parliament.uk"
  },
  ...
  "Farnham and Bordon": {
    ...
    "party": "Conservative",
    "email": "greg.stafford.mp@parliament.uk"
  },
  "Falkirk": {
    "name": "Euan Stainbank",
    "party": "Labour",
  ...
  "Henley and Thame": {
    ...
    "party": "Liberal Democrat",
    "email": "freddie.vanmierlo.mp@parliament.uk"
  },
  ...
  "Harlow": {
    "name": "Chris Vince",
    "party": "Labour",
    "email": "chris.vince.mp@parliament.uk"
  },
  "South Devon": {
...
async function lookup() {
      ...
      const resDiv = container.querySelector('.result');
      if (!pc) {
        resDiv.textContent = 'Please enter a postcode';
        return;
      }
      resDiv.textContent = 'Looking up…';
      ...
      try {
        ...
        const con = data.result && data.result.parliamentary_constituency;
        if (!con || !window.aslefMpList[con]) {
          resDiv.textContent = con
            ? 'No MP data for ' + con
            : 'No constituency found';
          return;
        }

        const mp = window.aslefMpList[con];
        const lines = [
          `Dear ${mp.name},`,
          ``,
          ...
          `Rail freight contributes to the UK economy, protects the climate, increases road safety, and creates jobs.`,
          `We need rail freight to build homes and infrastructure and to deliver the goods, medicine and food that people need.`,
          `A lack of investment in rail infrastructure alongside rising costs has disadvantaged rail freight over the last decade.`,
          `This must change.`,
          `As my MP I am asking that you:`,
          `- Read the report by ASLEF at [Insert Link]`,
          `- Call for investment in the railways and speak up for rail freight`,
          `- Support reinstating HS2 to increase capacity for freight and passengers`,
          `- Raise rail freight in GBR planning with stronger growth targets`,
          `- Call on the Government to utilise DRS or create public freight operators under GBR`,
          ``,
          `You can find more information at www.aslef.org.uk/railfreightfuture`,
          ``,
          `Thank you.`,
          `Yours sincerely,`
        ];
        ...
        console.error(err);
        resDiv.textContent = 'Error — please try again later';
      }
    }
container.querySelector('#aslef-find-btn')
             .addEventListener('click', lookup);
  });
})(window, document);
